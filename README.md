This is a modded Shadowsocks-Android that can act as a simple socks5/shadowsocks front proxy client.

Simply set encryption mode to "none" or leave the password to empty. Compile method can be read down below.
